...
const BASE_PLACEMENTS = {
  ...
  tiktok: ["profile", "post"],
  x: ["post", "morning-reserve", "evening-reserve"],
  threads: ["post", "morning-reserve", "evening-reserve"],
  facebook: ["post", "morning-reserve", "evening-reserve"],
  bluesky: ["post", "morning-reserve", "evening-reserve"],
